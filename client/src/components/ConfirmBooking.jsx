  ...
  {bookingConfirmed && (
    <div className="w-full flex flex-col h-full relative">
      ...
      <div className="flex-grow p-5 flex flex-col justify-between">
        <p><span className="font-inconsolata">Bokningsnummer:</span> X2354</p>
        <p><span className="font-inconsolata">Film:</span> Past lives</p>
        ...
        <p>Tel: 07633XXXXX</p>
        Pris: 670 SEK
        <button onClick={handleCloseConfirmation} className='booking-btn mt-4 text-white-100 py-1 px-2.5 rounded-sm bg-black-100 md:w-1/2 mx-auto'>
          Stäng
        </button>
      </div>
    </div>
