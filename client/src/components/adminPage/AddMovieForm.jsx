...
export default function AddMovieForm() {
    ...
    const adminGuides = {
        Titel: "Titel = Skriv filmens titel med stor bokstav. Om svensk titel finns så ska denna skrivas.",
        Handling: "Handling = Beskriv filmens handling.",
        ...
        Regissör : "Regissör = Skriv namnet på regissör eller regissör. Vid flera, skriv exempelvis: Martin Scorsese, Quentin Tarantino.",
        Skådespelare: "Skådespelare = Skriv namnet på skådespelarna enligt liknande: Robert Downey Jr, Will Smith, Michael Douglas.",
        Längd: "Filmens längd = Skriv in filmens längd på detta vis: 2 tim 13 min.",
        Genre: "Genre = Skriv filmens genre, exempelvis Drama. Vid flera genre, skriv Drama, Action, Thriller.",
        Språk: "Språk = Skriv de språk de talar i filmen. Exempelvis: Svenska.",
        Undertexter: "Undertext = Skriv de undertexter biografen erbjuder just denna film.",
        Åldersgräns: "Åldersgräns = Vilken är filmens rekommenderade åldersgräns? Detta väljs i rullgardinsmenyn för denna rad (7, 11 eller 15 år)"
    };
        ...
        <div className="mx-auto w-96 " >
            ...
            <form className=" relative  text-black" action={`/api/movies/${authToken}`} method="post" encType="multipart/form-data ">
                ...
                <div className="mt-5 ml-8 " >
                     ...
                     <input type="file" name="img_poster" id="files" multiple className="text-white mb-5 " />
                </div>
