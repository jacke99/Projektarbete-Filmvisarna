  ...
  return (
    ...
    mx-4 my-2 min-w-[140px] rounded-xl bg-gradient-to-r from-footerGrey to-primary p-6 flex flex-col gap-3 text-white max-w-[400px]">
      ...
      <input className=" bg-white-500 shadow appearance-none border rounded-lg  py-2 px-3 m-2
       text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="username" placeholder="Användarnamn.." />
      <input className=" bg-white-500 shadow appearance-none border rounded-lg  py-2 px-3 m-2
       text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="password" name="password" placeholder="Lösenord.." />
      <button className="bg-gold text-black-100 rounded-md px-4 p-1 self-center">Logga in</button>
