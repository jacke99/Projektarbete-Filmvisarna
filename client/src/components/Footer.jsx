    ...
    <footer className="px-3 bottom-0 w-full bg-[#363636] text-white">
      <div className="flex justify-between pt-6">
        ...
        <div className="flex gap-4 md:gap-6 lg:gap-8 mt-1 lg:mb-4 lg:mr-2">
          ...
          <img src={fotterIconIG} alt="IG_icon" className="h-3 w-3 lg:h-6 lg:w-6 md:h-4 md:w-4" />
          <img src={fotterIconIN} alt="TW_icon" className="h-3 w-3 lg:h-6 lg:w-6 md:h-4 md:w-4" />
        </div>
      </div>
