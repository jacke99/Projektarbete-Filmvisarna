...
<div className="max-w-full p-4 flex items-center justify-between lg:justify-start lg:px-96">
      <img
        src={killersPoster}
        alt="movie poster from Killers of the flower moon"
        className="w-34 h-48 rounded-lg"
      />
      <div className="text-white-100 flex flex-col lg:px-6">
      ...
      <button className="bg-gold text-black-100 rounded-md px-4 p-1 lg:ml-auto">Boka</button>
    </div>
