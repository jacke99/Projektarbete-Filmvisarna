...
export default function Register() {
  ...
  return <div className={`bg-[url('./assets/chairs.jpg')] bg-cover bg-center min-h-screen`} >
    <div className={`${styles.paddingY}`} >
        <h2 className={`${styles.headerText} ${styles.paddingBottom} text-white text-center`}>
      ...
      <header>
        <h1 className={`${styles.headerText} ${styles.paddingTop} ${styles.paddingBottom} text-white text-center`}>Bli medlem</h1>
      </header>
