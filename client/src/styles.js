const styles = {
  ...
  movieDescInfo: "text-white-100 sm:text-[12px] md:text-[15px] lg:text-[20px] flex flex-col py-2",
  ...
  buttonStyle:"hover:bg-white active:bg-gold bg-gold text-black-100 rounded-md px-3 text-sm p-1 md:px-5 md:py-2 md:text-base lg:text-lg lg:h-12",
  };
